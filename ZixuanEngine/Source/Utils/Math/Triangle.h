...
private:
	...
	ZE::FVec2 m_vectors[kNumPoints];

public:
	Triangle(const ZE::FVec2& vector1, const ZE::FVec2& vector2, const ZE::FVec2& vector3);
	Triangle() = default;
...
//---------------------------------------------------------------------------------------------------------------------
inline Triangle::Triangle(const ZE::FVec2& vector1, const ZE::FVec2& vector2, const ZE::FVec2& vector3)
{
	m_vectors[0] = vector1;
	m_vectors[1] = vector2;
	m_vectors[2] = vector3;
