...
public:
	...
	Circle() = default;	// I don't allow people to create a circle with out a center or a radius
	constexpr Circle(const ZE::FVec2& center, float radius);
...
// Custom Circle class
//---------------------------------------------------------------------------------------------------------------------
inline constexpr Circle::Circle(const ZE::FVec2& center, float radius)
	: m_center{ center }
	, m_radius{ radius }
